...
export const tracks: Track[] = [
  {
    ...
    duration: "3:02",
    mood: "Warm   Ambient",
    audioSrc: "/music/song1.flac",
    lrcSrc: "", 
    lyrics: [
      { time: 0.00, text: "..." },
      { time: 13.18, text: "ਤੇਰੇ ਉੱਤੇ ਮੁੱਕ ਜਾਣੀਆਂ ਨੀ ਧੜਕਣ ਰੁਕ ਜਾਣੀਆਂ" },
      { time: 19.25, text: "ਤੇਰੇ ਨਾਲ ਪਿਆਰ ਕੁੜੇ ਹੋ ਗਿਆ ਜਿੰਨਾ ਸਾਗਰਾਂ ਚ ਪਾਣੀ ਆ" },
      { time: 26.06, text: "ਮੈਂ ਸਾਂਭ ਸਾਂਭ ਰੱਖਲਾਂ ਐ ਚੰਦਰੇ ਜਹਾਨ ਤੋਂ" },
      { time: 30.18, text: "ਨੀ ਤੈਨੂੰ ਲੈਕੇ ਉੱਡ ਜਾਵਾਂ ਉੱਚਾ ਅਸਮਾਨ ਤੋਂ ਨੀ" },
      { time: 33.64, text: "ਹੋਜੇ ਮੇਰੀ ਤੂੰ ਵੀ ਗੱਲ ਮੇਰੀ ਸੁਣ ਲੈ ਨੀ" },
      { time: 37.56, text: "ਮੈਂ ਤੇ ਤੇਰਾ ਸਾਰੇ ਦਾ ਸਾਰਾ ਹੀ ਹੋ ਗਿਆ" },
      { time: 40.78, text: "ਨੀ ਮੈਨੂੰ ਤੇਰੇ ਖਿਆਲ ਨੀ ਸੌਣ ਦਿੰਦੇ" },
      { time: 44.45, text: "ਨੀ ਦੇਖਲਾ ਜਮਾਨਾ ਸਾਰਾ ਸੌਂ ਗਿਆ" },
      { time: 47.34, text: "ਨੀ ਮੈਨੂੰ ਤੇਰੇ ਖਿਆਲ ਨੀ ਸੌਣ ਦਿੰਦੇ" },
      { time: 50.71, text: "ਨੀ ਦੇਖਲਾ ਜਮਾਨਾ ਸਾਰਾ ਸੌਂ ਗਿਆ" },
      { time: 69.21, text: "ਓ ਤਿੱਖੜ ਦੁਪਹਿਰ ਖਿੜੀ ਧੁੱਪ ਜਿਹੀ ਤੇਰੀ ਮੁਸਕਾਨ ਐ" },
      { time: 74.80, text: "ਤੂੰ ਮੇਰੇ ਵੱਲ ਵੇਖ ਫਿਰ ਹੱਸ ਕੇ ਨੀ ਕੀਤਾ ਅਹਿਸਾਨ ਐ" },
      { time: 82.31, text: "ਨੀ ਤੇਰੇ ਉੱਤੇ ਤਰਜਾਂ ਬਣਾਈ ਜਾਵਾਂ ਸੋਹਣੀਏ" },
      { time: 85.35, text: "ਤੇਰੇ ਕੋਲ ਬੈਠਕੇ ਸੁਣਾਈ ਜਾਵਾਂ ਸੋਹਣੀਏ" },
      { time: 88.79, text: "ਤੂੰ ਲੱਗੇ ਮੈਨੂੰ ਸ਼ਿਵ ਦੀਆਂ ਗੀਤਾਂ ਵਰਗੀ" },
      { time: 91.94, text: "ਨੀ ਮੇਰਾ ਸਮਾਂ ਤੇਰੇ ਉੱਤੇ ਆ ਖਲੋ ਗਿਆ" },
      { time: 95.79, text: "ਨੀ ਮੈਨੂੰ ਤੇਰੇ ਖਿਆਲ ਨੀ ਸੌਣ ਦਿੰਦੇ" },
      { time: 98.88, text: "ਨੀ ਦੇਖਲਾ ਜਮਾਨਾ ਸਾਰਾ ਸੌਂ ਗਿਆ" },
      { time: 102.31, text: "ਨੀ ਮੈਨੂੰ ਤੇਰੇ ਖਿਆਲ ਨੀ ਸੌਣ ਦਿੰਦੇ" },
      { time: 105.76, text: "ਨੀ ਦੇਖਲਾ ਜਮਾਨਾ ਸਾਰਾ ਸੌਂ ਗਿਆ" },
      { time: 123.75, text: "ਤੇਰੇ ਬਾਰੇ ਸੋਚਦਾ ਰਹਾਂ ਕੀ ਸੋਚ ਕੇ ਬਣਾਈ ਤੂੰ" },
      { time: 129.70, text: "ਤੈਨੂੰ ਮਿਲਿਆ ਕੀ ਇੱਕ ਵਾਰ ਮੈਂ ਫੇਰ ਲੇਖਾਂ ਚ ਲਿਖਾਈ ਤੂੰ" },
      { time: 136.81, text: "ਨੀ ਚੰਨ ਦਾ ਹੁਸਨ ਫਿੱਕਾ ਪਾਤਾ ਤੇਰੇ ਨੂਰ ਨੇ" },
      { time: 140.15, text: "ਤੂੰ ਚੁੰਨੀ ਤੇ ਜੜਾ ਲਏ ਤਾਰੇ ਸਾਰੇ ਜਿੰਨੇ ਦੂਰ ਨੇ" },
      { time: 143.27, text: "ਮੈਂ ਰਹਿਣਾ ਤੇਰੇ ਨਾਲ ਪਰਛਾਵਾਂ ਬਣਕੇ" },
      { time: 146.68, text: "ਦੀਦਾਰ ਤੇਰਾ ਜੀਣ ਦਾ ਸਹਾਰਾ ਹੋ ਗਿਆ" },
      { time: 150.67, text: "ਨੀ smੈਨੂੰ ਤੇਰੇ ਖਿਆਲ ਨੀ ਸੌਣ ਦਿੰਦੇ" },
      { time: 153.92, text: "ਨੀ ਦੇਖਲਾ ਜਮਾਨਾ ਸਾਰਾ ਸੌਂ ਗਿਆ" },
      { time: 156.91, text: "ਨੀ ਮੈਨੂੰ ਤੇਰੇ ਖਿਆਲ ਨੀ ਸੌਣ ਦਿੰਦੇ" },
      { time: 160.55, text: "ਨੀ ਦੇਖਲਾ ਜਮਾਨਾ ਸਾਰਾ ਸੌਂ ਗਿਆ" }
    ],
  },
  {
    name: "Saajna",
    ...
    audioSrc: "/music/song2.flac",
    lrcSrc: "",
    lyrics: [
      { time: 0.00, text: "..." },
      { time: 13.75, text: "Saajna... Saajna..." },
      { time: 22.74, text: "Tujhko hi bas dekh kar" },
      { time: 27.20, text: "Bhooli mujhko hi meri nazar" },
      { time: 31.00, text: "Tujhko shayad nahi hai khabar" },
      { time: 36.26, text: "Tujhko jeete hain hum kis kadar" },
      { time: 42.69, text: "Jude jo tere khawaab se" },
      { time: 47.13, text: "Toh toote hum neend se" },
      { time: 51.74, text: "Yeh kaisa tera ishq hai saajna" },
      { time: 60.59, text: "Tu haathon mein toh hai mere" },
      { time: 65.26, text: "Hai kyun nahin lakeeron mein" },
      { time: 69.63, text: "Yeh kaisa tera ishq hai saajna..." },
      { time: 70.00, text: "..." },
      { time: 99.22, text: "Tere bina kabhi raaten na ho meri" },
      { time: 108.34, text: "Tere kareeb ho mere ye din sabhi" },
      { time: 117.22, text: "Tere bina kabhi raaten na ho meri" },
      { time: 126.22, text: "Tere kareeb ho mere ye din sabhi" },
      { time: 135.27, text: "Jude jo tere khawaab se" },
      { time: 139.82, text: "Toh toote hum neend se" },
      { time: 144.37, text: "Yeh kaisa tera ishq hai Saajna" },
      { time: 153.39, text: "Tu haathon mein toh hai mere" },
      { time: 157.95, text: "Hai kyun nahi lakeeron mein" },
      { time: 162.44, text: "Yeh kaisa tera ishq hai Saajna" },
      { time: 171.77, text: "..." },
      { time: 189.76, text: "Tu saath hai agar" },
      { time: 194.22, text: "Tanha kyun hai safar" },
      { time: 198.91, text: "Itna bata mujhe" },
      { time: 203.29, text: "Kyun hai mujhse bekhabar" },
      { time: 207.93, text: "Tu saath hai agar" },
      { time: 212.50, text: "Tanha kyun hai safar" },
      { time: 217.07, text: "Itna bata mujhe" },
      { time: 221.40, text: "Kyun hai mujhse bekhabar" },
      { time: 225.88, text: "Jude jo tere khawaab se" },
      { time: 230.33, text: "Toh toote hum neend se" },
      { time: 234.90, text: "Yeh kaisa tera ishq hai Saajna" },
      { time: 243.80, text: "Tu haathon mein toh hai mere" },
      { time: 248.45, text: "Hai kyun nahi lakeeron mein" },
      { time: 253.08, text: "Yeh kaisa tera ishq hai saajna" }
    ],
  },
  {
    name: "Perfect",
    ...
    lrcSrc: "",
    lyrics: [
      { time: 2.75, text: "I found a love for me" },
      { time: 10.14, text: "Oh, darlin', just dive right in and follow my lead" },
      { time: 17.72, text: "Well, I found a girl, beautiful and sweet" },
      { time: 25.29, text: "Oh, I never knew you were the someone waitin' for me" },
      { time: 31.99, text: "'Cause we were just kids when we fell in love" },
      { time: 36.75, text: "Not knowing what it was, I will not give you up this time" },
      { time: 44.04, text: "But, darling, just kiss me slow, your heart is all I own" },
      { time: 55.75, text: "And in your eyes you're holding mine" },
      { time: 62.27, text: "Baby, I'm dancing in the dark, with you between my arms" },
      { time: 70.71, text: "Barefoot on the grass, while listenin' to our favourite song" },
      { time: 80.04, text: "When you said you looked a mess, I whispered underneath my breath" },
      { time: 87.72, text: "But you heard it, darling, you look perfect tonight" },
      { time: 101.10, text: "Well, I found a woman, stronger than anyone I know" },
      { time: 108.77, text: "She shares my dreams, I hope that someday I'll share her home" },
      { time: 116.37, text: "I found a love, to carry more than just my secrets" },
      { time: 124.50, text: "To carry love, to carry children of our own" },
      { time: 130.72, text: "We are still kids, but we're so in love, fighting against all odds" },
      { time: 139.23, text: "I know we'll be alright this time" },
      { time: 146.04, text: "Darling, just hold my hand, be my girl, I'll be your man" },
      { time: 154.25, text: "I see my future in your eyes" },
      { time: 160.00, text: "Baby, I'm dancing in the dark, with you between my arms" },
      { time: 172.33, text: "Barefoot on the grass, while listenin' to our favourite song" },
      { time: 179.27, text: "When I saw you in that dress, looking so beautiful" },
      { time: 185.27, text: "I don't deserve this, darling, you look perfect tonight" },
      { time: 199.37, text: "No, no, no" },
      { time: 202.68, text: "Mm, no, no" },
      { time: 206.50, text: "Baby, I'm dancing in the dark, with you between my arms" },
      { time: 217.63, text: "We're barefoot on the grass, oh, listenin' to our favorite song" },
      { time: 224.74, text: "I have faith in what I see" },
      { time: 228.23, text: "Now I know I have met an angel in person" },
      { time: 234.50, text: "And she looks perfect, I don't deserve this" },
      { time: 242.37, text: "You look perfect tonight" }
    ],
  },
];
