...
export const tracks: Track[] = [
  {
    ...
    duration: "3:02",
    mood: "Warm · Ambient",
    audioSrc: "public/music/Your Thoughts.flac",
    lrcSrc: "public/music/Your Thoughts.lrc",
    lyrics: [],
  },
  {
    name: "Saajna",
    ...
    audioSrc: "public/music/Saajna.flac",
    lrcSrc: "public/music/Saajna.lrc",
    lyrics: [],
  },
  {
    name: "Perfect",
    duration: "4:23",
    mood: "Bright · Lovely",
    audioSrc: "public/music/Perfect.m4a",
    lrcSrc: "public/music/Perfect.lrc",
    lyrics: [],
  },
];
